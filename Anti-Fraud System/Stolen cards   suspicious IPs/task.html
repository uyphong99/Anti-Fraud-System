...
<p><button class="btn-sm btn-outline-secondary" onclick="getElementById('hint-1392').style.display='inline'">
        Hint
      </button>
</p><div id="hint-1392" style="display:none;">If you want to know more about Luhn algorithms, take a look at the <a href="https://en.wikipedia.org/wiki/Luhn_algorithm" rel="noopener noreferrer nofollow" target="_blank">Wikipedia page</a> of the same name or complete the <a href="https://hyperskill.org/projects/93" rel="noopener noreferrer nofollow" target="_blank">Simple Banking System</a> project on Hyperskill.</div>
